  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="rounded-2xl p-6" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div className="rounded-2xl p-6" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <p className="text-3xl font-bold" style={{ color: 'var(--text-primary)' }}>{stats.total_checkins_today}</p>
        ...
        <div className="rounded-2xl p-6" style={{ backgroundColor: 'var(--bg-secondary)', border: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <p className="text-3xl font-bold" style={{ color: 'var(--text-primary)' }}>{stats.active_activities}</p>
